...
class MSResNet(nn.Module):
    def __init__(self, input_channel, layers=[1, 1, 1, 1], num_classes=10):
        ...
        self.conv2 = nn.Conv1d(16, 16, kernel_size=7, stride=2, padding=3,bias=False)
        self.bn2 = nn.BatchNorm1d(16)
        self.relu2 = nn.ReLU(inplace=True)

        self.layer3x3_1 = self._make_layer3(BasicBlock3x3, 16, layers[0], stride=2)
        self.layer3x3_2 = self._make_layer3(BasicBlock3x3, 32, layers[1], stride=2)
        ...
        self.layer5x5_1 = self._make_layer5(BasicBlock5x5, 16, layers[0], stride=2)
        self.layer5x5_2 = self._make_layer5(BasicBlock5x5, 32, layers[1], stride=2)
        self.layer5x5_3 = self._make_layer5(BasicBlock5x5, 64, layers[2], stride=2)
        ...
        self.layer7x7_1 = self._make_layer7(BasicBlock7x7, 16, layers[0], stride=2)
        self.layer7x7_2 = self._make_layer7(BasicBlock7x7, 32, layers[1], stride=2)
        self.layer7x7_3 = self._make_layer7(BasicBlock7x7, 64, layers[2], stride=2)
